...
| **Measured** FP16 batch-16 DRAM traffic: weight 81.2 % / KV payload 12.5 % / KV metadata 6.3 % | kv-asymmetry-npu | `df079b5` | `audit/p3_metadata_result.md:268-272` — 436,207,616 / 67,117,056 / 33,622,016 bytes | not rerun | `verified-historical` |
| **Projected** INT4 batch-64: weight 21.3 % / KV payload 52.4 % / KV metadata 26.3 % | kv-asymmetry-npu | `df079b5` | `audit/p3_metadata_result.md:294` labels the section verbatim *"해석적 확장 (시뮬레이션 아님, 산술)"* — analytical extension, **not simulation** | **never simulated** — arithmetic extension of the row above via two scaling laws | **`ANALYTICAL`** — hypothesis-generating projection, never a measured result. Earlier revisions of this portfolio presented it as measured; that was wrong and is corrected here |
...
| `kv_head_idx` GQA/MHA mapping bug found, fixed, and **submitted upstream as an issue and a pull request** | onnxim-kv-instrumented + [ONNXim fork](https://github.com/oyeong011/ONNXim/tree/fix/kv-head-idx-gqa-mapping) | `511a52a` / `69e6189` | upstream [issue #33](https://github.com/PSAL-POSTECH/ONNXim/issues/33) and [PR #34](https://github.com/PSAL-POSTECH/ONNXim/pull/34), both filed 2026-08-14, both **open** | `gh pr view 34 --repo PSAL-POSTECH/ONNXim` | **verified-current** — issue and PR re-queried 2026-08-25; both exist and are open. **Not merged**, and no maintainer response yet — claimed as *submitted*, never as *accepted* |
